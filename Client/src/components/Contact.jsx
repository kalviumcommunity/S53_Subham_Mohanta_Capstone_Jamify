                ...
                <div className='contact-box'>
                    ...
                    <div className='links'>
                        <div className='link-1'>
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=subhammohanta99@gmail.com" style={{textDecoration:"none", color:"#f4f4f4", display: "flex", alignItems:"center"}} target="_blank" rel="noopener noreferrer">                        <svg width="28" height="26" viewBox="0 0 42 32" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M42 4.298V8.2L32 15.7V3.2L35.124 0.859C35.868 0.301 36.772 0 37.702 0C40.076 0 42 1.924 42 4.298Z" fill="#FBC02D"/>
                            ...
                            <p style={{marginLeft:"12px"}}>Gmail</p></a>
                        </div>
                        <div className='link-2'><a href="https://www.linkedin.com/in/subham-mohanta-59b683289/?msg=1" style={{textDecoration:"none", color:"#f4f4f4", display: "flex", alignItems:"center"}} target="_blank" rel="noopener noreferrer">
